...
namespace SerialPortWave
{
    public partial class FormMain : Form
    {
        ...
        Steema.TeeChart.Styles.Line red = new Steema.TeeChart.Styles.Line();
        Steema.TeeChart.Styles.Line blue = new Steema.TeeChart.Styles.Line();
            ...
            try
            {
                ...
                this.Invoke((EventHandler)(delegate
                {
                    ...
                    if (disflag == true && reChartUpdate == true)
                        reChartUpdate = false;
                    tChart1.Chart.Series.Clear();
                    tChart1.Chart.Series.Add(red);
                    tChart1.Chart.Series.Add(blue);
